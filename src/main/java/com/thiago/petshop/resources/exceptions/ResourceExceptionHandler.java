...
import com.thiago.petshop.service.exceptions.DataIntegrityException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardErro> objectNotFound(DataIntegrityException e, HttpServletRequest request){
		
		StandardErro erro = new StandardErro(HttpStatus.BAD_REQUEST.value(), e.getMessage());
